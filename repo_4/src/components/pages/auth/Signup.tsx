            ...
            <Card className="w-full max-w-md border shadow-sm">
                ...
                <form onSubmit={handleSubmit}>
                    <CardContent className="space-y-4">
                        ...
                        {/* Department and Year will be handled in Onboarding, but keeping basic fields here for initial account creation */}
                        {/* Or we can simplify this form to just email/password and do the rest in Onboarding */}
                        {/* Sticking to repo_6 logic for now */}
